package com.elon.jdbc.day02.stmt.member.controller.view;

import java.util.List;
import java.util.Scanner;

import com.elon.jdbc.day02.stmt.member.controller.controller.MemberController;
import com.elon.jdbc.day02.stmt.member.controller.model.vo.Member;
		...
		while(true) {
			...
			case 5 : 
				...
				if(member != null) {
					...
					// 결과에 따른 메시지 출력하기 
					if(result > 0) {
						printMessage("회원 정보 삭제가 완료 되었습니다.");
					} else {
